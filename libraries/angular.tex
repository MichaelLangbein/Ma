...
\begin{itemize}
    ...
    \item feature module: exports thematic components, directives and pipes in its \inlinecode{declarations} & \inlinecode{exports}. Should be imported only in app-module.
    ...
    \item shared module: exports globally used components, directives and pipes in its \inlinecode{declarations} & \inlinecode{exports}. Should be imported into any module that requires it.
