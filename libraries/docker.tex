    ...
    \item \inlinecode{docker} \begin{itemize}
        ...
        \item \inlinecode{container} \begin{itemize}
                \item \inlinecode{run -p 4000:80 -d --name=<nameofyourcontaineralllowercase> <nameofyourappalllowercase>}execute that package
                    ...
                    i.e. get back control of your command-line after starting the container). \inlinecode{run} is actually a shorthand for \inlinecode{create} and \inlinecode{start}. \begin{itemize}
                ...
                \item \inlinecode{cp /path/to/local/file.html my-nginx:/var/www/html}
                \item \inlinecode{exec -it my-nginx /bin/bash}
