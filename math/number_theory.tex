...
\begin{theorem}[Euclids algorithm] 
	We can simplify the greatest common divisor like this: 
	$$ \gcd{a, b} = \gcd{b, \rem{a,b}} $$
\end{theorem}
\begin{proof}
	\subprf{}{We'll prove that $\CD{a,b} = \CD{b, \rem{a,b}}$}{
	...
	\subprf{}{Since $A=B \then \max{A} = \max{B}$, it follows that $\gcd{a,b} = \gcd{b, \rem{a,b}}}{
