...
\begin{theorem} \label{symm_then_orth}
    $\mtrx{A}: \symm \then \mtrx{E}: \orth$
    \begin{equation}
        \begin{aligned}
                                                                    & <Ae_1, e_2>           &= <e_1, A^Te_2> \\
            \text{Since } A:\symm:                                  & <Ae_1, e_2>           &= <e_1, Ae_2> \\
            \text{Since } e_1, e_2 \text{ are eigenvalues of } A:   & <\lambda_1 e_1, e_2>  &= <e_1, \lambda_2 e_2> \\
                                                                    & \lambda_1 <e_1, e_2>  &= \lambda_2 <e_1, e_2>
        \end{aligned}
    \end{equation}
    Thus, either $\lambda_1 = \lambda_2$ or $e_1 \orth e_2$ 
\end{theorem}
