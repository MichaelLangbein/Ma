...
\paragraph{Properties of matrices} will be proven here. 
...
\paragraph{Matrix inverse and transpose} will be handled here. 


\subsection{Important \emph{non}properties}
...
\paragraph{A linear transformation can also be a change of basis} when the following conditions are fullfilled: 
