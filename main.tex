...
\usepackage{amssymb} % For convoultion icon and preferrance icon
...
\usepackage{tabularx} % for tables with automatic linebreaks
\usepackage[toc,page]{appendix}
\usepackage{titlesec} % for numbers on subsubsection
\usepackage{pifont}% http://ctan.org/pkg/pifontn for \checkmark and \xmark
\usepackage{adjustbox} % to shrink very wide tables
...
%linalg
% \let\vec\mathbf %\renewcommand{\vec}[1]{\ensuremath{\mathbf{#1}}}
\newcommand{\mtrx}[1]{\ensuremath{\mathbf{#1}}}
\newcommand{\nullspace}[1]{\ensuremath{\mathcal{N}_{#1}}}
\newcommand{\collspace}[1]{\ensuremath{\mathcal{C}_{#1}}}
\newcommand{\rowspace}[1]{\ensuremath{\mathcal{R}_{#1}}}
\newcommand{\solspace}[1]{\ensuremath{\mathcal{S}_{#1}}}
\newcommand{\dimension}[1]{\ensuremath{\text{dim}_{#1}}}
\newcommand{\rank}[1]{\ensuremath{\text{rank}_{#1}}}
\newcommand{\symm}{\ensuremath{\text{sym}}}
\newcommand{\orthtxt}{\ensuremath{\text{orth}}}
\newcommand{\PSD}{\ensuremath{\text{PSD}}}
%algebraic geometry
...
%distsys
\newcommand{\nodes}[1]{\ensuremath{ \text{nodes}_{#1} }}
\newcommand{\edges}[1]{\ensuremath{ \text{edges}_{#1} }}
%programming
...
% economics
\newcommand{\preferred}{\ensuremath{\succsim}}
\newcommand{\nonpreferred}{\ensuremath{\precsim}}
%legal
...
\input{math/distributed_systems}
\input{math/ai}
...
\input{programming/xml}
\input{programming/designpatterns}

\chapter{Stacks, platforms and libraries}
\input{libraries/docker}
\input{libraries/spring}
\input{libraries/springBoot}
...
\chapter{Sciences}
\input{science/remote_sensing}
\input{science/economics}
\input{science/projects}

\chapter{Art}
\input{art/design}
\input{art/math}
\input{art/programming}
