...
\begin{tabularx}{1.2\textwidth}{XXXXXX}
    ...
    user-file       & \inlinecode{const module = require('./module.js'); module.area(4);} & \inlinecode{const module = require('./module.js'); module.area(4);}      & \inlinecode{require} &                        & \inlinecode{\{import \{ sqrt \} from 'module';\}}  \\
