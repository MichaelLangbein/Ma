...
\section{CSS}
CSS is so full of ideosyncracies it's really hard to keep track of them all. Here's an attempt to list the worst offenders.
...
\begin{itemize}
    \item \textbf{block}
    \item \textbf{inline}
    \item \textbf{inline-block}: inline, but allows width, height, padding etc.
    \item \textbf{none}
    \item \textbf{table}
    \item \textbf{grid}
