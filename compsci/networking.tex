...
Because that is way too much work with several millions of computers in the world, we have hubs. Hubs are even simpler devices than switches: they connect tow nets of computers, and if a destination-mac is on the other net, they allow the frame to be broadcasted to all computers in both nets; otherwise they block the frame, which makes it only broadcast to its source-net.
